...
class CustomKMeans(KMeans):
    def __init__(self, n_clusters=8, *, init='k-means++', n_init=10, max_iter=300,
                 tol=1e-4, verbose=0, random_state=None, copy_x=True, algorithm='auto'):
...
# 3. 创建CustomKMeans模型，并进行拟合和预测
# 3. 创建CustomKMeans模型，并进行拟合和预测
kmeans = CustomKMeans(n_clusters=n_clusters, random_state=42, algorithm='lloyd')
