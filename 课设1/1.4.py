...
def main():
    ...
    models = [
        ...
        (GaussianNB(), "朴素贝叶斯"),
        (BaggingClassifier( n_estimators=100, random_state=42), "Bagging集成"),
        (RandomForestClassifier(n_estimators=100, random_state=42), "随机森林"),
        (GradientBoostingClassifier(n_estimators=100, random_state=42), "梯度提升")
    ]
